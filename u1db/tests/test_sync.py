...
class DatabaseSyncTests(tests.DatabaseBaseTests):
    ...
    def test_sync_tracks_db_generation_of_other(self):
        ...
        self.assertEqual((0, ''), self.db1._get_sync_info('test2'))
        self.assertEqual((0, ''), self.db2._get_sync_info('test1'))
    ...
    def test_sync_puts_changes(self):
        ...
        self.assertEqual(1, self.db1._get_sync_info('test2')[0])
        self.assertEqual(1, self.db2._get_sync_info('test1')[0])
        self.assertLastExchangeLog(self.db2,
    ...
    def test_sync_doesnt_update_other_if_nothing_pulled(self):
        ...
        self.assertEqual(1, self.db2._get_sync_info(self.db1._replica_uid)[0])
    ...
    def test_sync_supersedes_conflicts(self):
        ...
        self.assertEqual(
            self.db1._get_generation_info(),
            db3._get_sync_info(self.db1._replica_uid))
        self.assertEqual(
            db3._get_generation_info(),
            self.db1._get_sync_info(db3._replica_uid))
        self.sync(db3, self.db2)
        self.assertEqual(
            self.db2._get_generation_info(),
            db3._get_sync_info(self.db2._replica_uid))
        self.assertEqual(
            db3._get_generation_info(),
            self.db2._get_sync_info(db3._replica_uid))
